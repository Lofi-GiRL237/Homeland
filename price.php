...
if (isset($_GET['price'])) {
    ...
    if ($price === 'ASC' || $price === 'DESC') {
        $select = $conn->prepare("SELECT * FROM props ORDER BY price $price");
    } else {
    ...
    $order = 'DESC';
    $query = $conn->prepare("SELECT * FROM props ORDER BY price $order");
    $query->execute();
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="property-entry h-100">
              ...
              <div class="p-4 property-body">
                ...
                <h2 class="property-title"><a href="property-details.php?id=<?php echo $prop->id; ?>">
                    <?php echo $prop->name; ?></a></h2>
